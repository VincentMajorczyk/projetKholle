...
<body>
    ...
    <form class="l" method="post">
        ...
        <div class="gauche">
            ...
            <div class="container-creneaux">
                ...
                <li class="creneau-item" id="{{$creneau->id}}" data-id="{{$creneau->id}}" data-matiere="{{ \App\Models\Matiere::find($creneau->matiere)["nommatiere"]}}" data-salle="{{$creneau->sallecreneau}}" data-matiere="{{ \App\Models\Matiere::find($creneau->matiere)["nommatiere"]}}" data-date="{{$creneau->datecreneau}}" data-etudiant="{{ \App\Models\User::find($creneau->id_etudiant)["nom"]}}" data-etudiantp="{{\App\Models\User::find($creneau->id_etudiant)["prenom"]}}" data-heure="{{ $creneau->heurecreneau}}" data-duree="{{ $creneau->duree}}"> 
    ...
    <form class="r">
        ...
        <div class="droite">              
            ...
            <table class="input-table">
            <tr>
                    <th><label for="nomEtudiant">Nom de l'étudiant :</label></th>
                    <td><input name="nomEtudiant" type="text" id="nomEtudiant" readonly></td>
                    <td><input name="idCreneau" type="hidden" id="idCreneau" readonly></td>
                </tr>
                <tr>
                    <th><label for="prenomEtudiant">Prénom de l'étudiant :</label></th>
                    <td><input name="prenomEtudiant" type="text" id="prenomEtudiant" readonly></td>
                </tr>
                <tr>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        creneauItems.forEach(function(item) {
            item.addEventListener('click', function() {
                ...
                document.getElementById('nomEtudiant').value = this.getAttribute('data-etudiant');
                document.getElementById('prenomEtudiant').value = this.getAttribute('data-etudiantP');
